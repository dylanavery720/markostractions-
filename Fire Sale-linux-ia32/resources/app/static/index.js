...
$_mod.def("/fire-sale$0.0.1/index", function(require, exports, module, __filename, __dirname) { var helloComponent = require('/fire-sale$0.0.1/components/hello.marko'/*'./components/hello.marko'*/);

helloComponent.renderSync({ name:'Marko' })
    .appendTo(document.body);

});
$_mod.run("/fire-sale$0.0.1/index");